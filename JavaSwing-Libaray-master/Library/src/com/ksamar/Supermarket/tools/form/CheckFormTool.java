package com.ksamar.Supermarket.tools.form;

import com.ksamar.Supermarket.views.book.BookFormView;
import com.ksamar.Supermarket.views.message.Message;
import com.ksamar.Supermarket.views.user.UserFormView;
...
public class CheckFormTool {
    ...
    public static boolean checkBookForm(BookFormView bookFormView) {
        if ("".equals(bookFormView.groupsComboBox.getSelectedItem()) || "请选择类别".equals(bookFormView.groupsComboBox.getSelectedItem())) {
            Message.showMessage("请选择类别", "错误", 0);
        } else if ("".equals(bookFormView.bookNameField.getText())) {
            Message.showMessage("请输入商品名", "错误", 0);}
...
//        }
            ...
            Message.showMessage("请输入厂家", "错误", 0);
            ...
            Message.showMessage("请输入GTIN号码", "错误", 0);
            ...
            Message.showMessage("请输入正确的GTIN号码", "错误", 0);
        } else {
            return true;
        }
    ...
    public static boolean checkUserForm(UserFormView userFormView) {
        if ("".equals(userFormView.groupsComboBox.getSelectedItem()) || "请选择类别".equals(userFormView.groupsComboBox.getSelectedItem())) {
            Message.showMessage("请选择类别", "错误", 0);
            ...
            Message.showMessage("请输入商品卡号", "错误", 0);
