package com.ksamar.Supermarket.tools.image;
...
public class Images {
     ...
     * 图片地址
     */
    public static String url = "com/ksamar/Supermarket/images";
    ...
    static {
        ...
        bookIcon = new ImageIcon(Objects.requireNonNull(Images.class.getResource(url + "products.png")));
