...
import com.ksamar.Supermarket.controller.products.ProductsTypeController;
...
import com.ksamar.Supermarket.tools.view.View;
...
public class BookFormView extends JFrame {
     ...
     * 属性
     */
    public String bookFormText = "商品表单";
    public String groupsText = "商品类别";
    public String bookNameText = "商品名";
    //public String bookAuthorText = "作者";
    public String bookPressText = "厂家";
    public String bookPriceText = "价格(人民币)";
    public String bookCountText = "数量";
    public String bookIsbnText = "GTIN号码";
...
//        bookFormPanel.add(bookAuthorField);
    ...
    public void resetForm() {
        groupsComboBox.setSelectedItem("请选择类别");
    ...
    public void setGroupsComboBox() {
        List<ProductsType> productsTypes = ProductsTypeController.getType();
        for (ProductsType productsType : productsTypes) {
            groupsComboBox.addItem(productsType.getTypeName());
        }
    }
}
