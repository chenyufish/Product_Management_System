...
import com.ksamar.Supermarket.views.user.AddUserView;
import com.ksamar.Supermarket.views.user.DeleteUserView;
import com.ksamar.Supermarket.views.user.EditUserView;
...
public class UserView extends JPanel {
     ...
     * 表格模型
     */
    String[] name = {"Id", "组名", "姓名", "用户名", "密码", "性别", "商品号", "手机号", "身份", "可借书数量", "状态"};
