package com.ksamar.Supermarket.views.system;
...
public class AddBookTypeView extends JFrame {
     ...
     * 属性
     */
    private String titleText = "添加商品种类";
    ...
    private AddBookTypeView() {
        ...
        // 添加图书种类标签
        addBookTypeTextLabel.setText("商品种类");
    ...
    private void addBookType() {
        ...
        if (!"".equals(text)) {
            ...
            productsType.setTypeName(text);
            String typeId = String.valueOf(10001 + ProductsTypeController.getTypeCount());
            productsType.setTypeId(typeId);

            int result = ProductsTypeController.addType(productsType);
            ...
            errorMessageLabel.setText("请输入商品种类");
        }
    }
