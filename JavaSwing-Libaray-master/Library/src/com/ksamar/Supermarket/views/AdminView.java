...
import com.ksamar.Supermarket.tools.popupmenu.Menu;
...
public class AdminView extends JFrame {
     ...
     * 文字
     */
    private String titleText = "进销存管理系统";
    private String subTitleText = "主页";
    private String homeText = "主页";
    private String bookText = "商品管理";
    private String borrowText = "商品出库";
    private String returnText = "商品退回";
...
//        overtimeButton.add(overtimeTextLabel);
        ...
        userButton.setBounds(0, 304, 240, 48);
        ...
        systemButton.setBounds(0, 360, 240, 48);
