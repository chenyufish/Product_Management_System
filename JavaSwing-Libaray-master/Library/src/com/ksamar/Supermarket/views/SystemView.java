...
import com.ksamar.Supermarket.views.system.AddBookTypeView;
import com.ksamar.Supermarket.views.system.ChangePasswordView;
import com.ksamar.Supermarket.views.system.DeleteBookTypeView;
...
public class SystemView extends JPanel {
    ...
    public SystemView() {
        ...
        // 添加图书种类按钮
        addBookTypeButton.setText("添加商品种类");
        ...
        // 删除图书种类按钮
        deleteBookTypeButton.setText("删除商品种类");
