...
public class HomeView extends JPanel {
     ...
     * 文字
     */
    private String bookText = "超市商品数量";
    private String borrowText = "卖出商品数量";
    private String overtimeText = "退回商品数量";
    ...
    public void init() {
        // 面板初始化
        bookCount = ProductsController.getBookCount();
        borrowCount = ProductsController.getBorrowCount();
        //overtimeCount = ProductsController.getOvertimeCount();
        setTime();
