...
//        bookAuthorLabel.setFont(Fonts.subTitle);
    ...
    private void searchBook() {
        ...
        if (book != null) {
            ...
            bookPriceLabel.setText(bookPriceText + book.getPrice());
            totalSumPrice += book.getPrice();
    ...
    private void borrowBookEvent() {
        if (checkForm()) {
            ...
            for (Book selectedBook : selectedBooks) {
                ...
                borrow.setBookName(selectedBook.getName());
                borrow.setIsbn(selectedBook.getIsbn());
